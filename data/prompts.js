const promptsData = {
  prompts: [
    {
      name: "clay-style",
      prompt: `Generate a 1024 × 1024 px high-resolution, smooth, clay-style warning sign.
...
No labels or extra text`,
    ...
    {
      name: "pixel-art",
      prompt: `Generate a 1024 × 1024 px high-resolution warning sign in pixel art style.
...
No anti-aliasing or blur effects`,
    ...
    {
      name: "minimalist",
      prompt: `Generate a 1024 × 1024 px high-resolution warning sign in minimalist style.
